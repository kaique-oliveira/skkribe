...
public partial class AppState : ObservableObject
{
    ...
    public string SelectedModel
    {
        ...
        set
        {
            ...
            {
                try { ApplicationData.Current.LocalSettings.Values[SelectedModelKey] = value; }
                catch { /* unpackaged: ignore */ }
            }
        }
    }
    ...
    private static string LoadStoredModel()
    {
        try
        {
            var v = ApplicationData.Current.LocalSettings.Values["selectedModel"] as string;
            return string.IsNullOrWhiteSpace(v) ? DefaultModel : v;
        }
